<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeathCertificate.aspx.cs" Inherits="DeathCertificate" %>
        ...
        <div style="height: 100%;">
                    ...
                    <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                        <div class="row" style="background-color: rgb(0,181,250);">
                            ...
                            <div class="col-sm-4" style="margin-top: 20px;">
                                <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%=Resources.Resource.DeathCertificate %></span>
                            </div>
                            <div class="col-sm-4" style="margin: 11px 12px 75px 20px; height: 77px; max-width: 30%; text-align: right;">
                                <a href="Default2.aspx">
                                    <div style="position: relative">
                                        <p style="top: 19px; position: absolute; right: 21px; font-size: larger; color: white; font-weight: 600">
            ...
            <div class="row" style="text-align: center; padding-left: 15px;">
                <div style="position: absolute; border: solid 1px #f00; width: 100%; margin-top: -7%; background: #eee; border-radius: 10px; text-align: center; height: 100%;">
                    <div class="row">
                        ...
                        <div class="col-md-10" style="border: solid 1px #b5b0b0; padding-top: 5px; padding-bottom: 10px; text-align: left; margin-top: 10px;">
                            <div class="row" style="margin-top: 5px;">
                                ...
                                <div class="col-md-4">
                                    <!---Enter Death Date- YYYY-MM-DD-->
                                    <%= Resources.Resource.DateOfDeath %> :
									<asp:TextBox ID="txtDate" runat="server" placeholder="<% $Resources:Resource,DeathDatePlaceholder  %>" autoComplete="off" CssClass="form-control"></asp:TextBox>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-1" style=""></div>
                        <div class="col-md-10" style="margin-top: 10px; overflow: overlay; height: 450px;">
                            <table class="col-md-12" style="border: groove; align-content: center;" runat="server" id="tblDOD">
                                <tr>
                                    <th><%= Resources.Resource.Name%></th>
                                    <th><%= Resources.Resource.Gender %></th>
                                    <th><%= Resources.Resource.DateOfDeath %></th>
