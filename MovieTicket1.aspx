<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MovieTicket1.aspx.cs" Inherits="Default2" %>
                ...
                <div class="col-sm-12" style="border: #000; width: 100%; margin-right: 0px; margin-top: -8%;">
                    <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                        <div class="row" style="background-color: #ff8f00;">
							...
							<a href="Entertainment1.aspx" id="btnMarathi"  style="font-size: 18px; color: #fff; font: bold; opacity: 0.5;"><%=Resources.Resource.entertainment %>/</a>
                            <a style="font-size: 18px; font: bold; color: white"><%=Resources.Resource.Movies %></a>--%>
                            </div>

                            <div class="col-sm-4" style="margin-top: 20px;">
                                <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%=Resources.Resource.Movies %></span>
                            </div>
                            <div class="col-sm-4" style="margin: 11px 12px 75px 20px; height: 77px; max-width: 30%; text-align: right;">
                                <a href="Entertainment1.aspx">
                    ...
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: 7%;">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                ...
                                <a href="https://in.bookmyshow.com/movies">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/bookmyshow.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.BookMyShow %>
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px; border: 1px solid #ff8f00; padding: 10px; height: 150px; background: #FFFFFF; border-radius: 10px;">
                                ...
                                <a href="https://paytm.com/movies">

                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/paymt.jpg" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.paytm %>
                                    </span>
                                </a>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: -1%;">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px 20px 80px; border: 1px solid #ff8f00; padding: 10px; height: 150px; background: #FFFFFF; border-radius: 10px;">
                                ...
                                <a href="https://techibhai.com/apps-movie-tickets-online/">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/techi.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.Techibhai %>
                                    </span>
                                </a>
                            </div>
