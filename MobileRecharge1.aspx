<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MobileRecharge1.aspx.cs" Inherits="Default2" %>
                ...
                <div class="col-sm-12" style="border: #000; width: 100%; margin-right: 0px; margin-top: -8%;">
                    <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                        <div class="row" style="background-color: #ff8f00;">
							...
							<a href="PaymentServices1.aspx" id="btnMarathi"  style="font-size: 18px;  color: #fff; font: bold;  opacity: 0.5;"><%=Resources.Resource.PaymentServices %>/</a>
							
                            <a style="font-size: 18px; font: bold; color: white"><%=Resources.Resource.mobilerecharge %></a>--%>
                            </div>

                            <div class="col-sm-4" style="margin-top: 20px;">
                                <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%=Resources.Resource.mobilerecharge %></span>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: 7%;">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                ...
                                <a href="https://www.freecharge.in/prepaid">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/freecharge.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.Freecharge %>
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px; border: 1px solid #ff8f00; padding: 10px; height: 150px; background: #FFFFFF; border-radius: 10px;">
                                ...
                                <a href="https://www.mobikwik.com/prepaid-recharge,">

                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/mobikwik.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.Mobikwik %> 
                                    </span>
                                </a>
                            </div>
