<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="GrievanceStatus.aspx.cs" Inherits="PropertyTax" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="background-color: #0c529c; height: 578px;">
                    ...
                    <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                        <div class="row" style="background-color: #0c529c;">
                            <div class="col-sm-4" style="text-align: left; margin-top: 2%">
                                <a runat="server" href="Default.aspx" style="font-size: 18px; font: bold; color: #fff; opacity: 0.5;"><%=Resources.Resource.Home %>/</a>
                                <a href="Default2.aspx" style="font-size: 18px; font: bold; color: white; opacity: 0.5;"><%=Resources.Resource.ESeverices %>/</a>
                                <a style="font-size: 18px; font: bold; color: white"><%=Resources.Resource.propertytax %></a>
                            </div>

                            <div class="col-sm-4" style="margin-top: 20px;">
                                <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif">Grievance Status</span>
                            </div>
            ...
            <div class="row" style="text-align: center; padding-left: 3%;">
                <div style="position: absolute; border: solid 1px #f00; width: 96%; margin-top: -7%; background: #eee; border-radius: 10px; text-align: center; height: 595px;">
                    <div class="row">
                        <div class="col-md-4" style="">
                        </div>
                        <div class="col-md-4" style="border: solid 1px #b5b0b0; padding-top: 5px; padding-bottom: 10px; text-align: left; margin-top: 10px;">
                            Grievance Token Number<span style="color: #f00;"> *</span>
                            <div class="row">
                                <div class="col-sm-7">
                                    <asp:TextBox runat="server" ID="txtTokenNo" AutoComplete="off" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="col-sm-5">
                                    <asp:Button runat="server" ID="btnGetGrievanceStatus" Width="130px" CssClass="btn btn-primary" Text="<%$Resources:Resource,Show %>" OnClick="btnGetGrievanceStatus_Click" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                        ...
                        <div class="col-md-6" style="padding-right: 0px;">
                            <div class="col-md-11" style="text-align: left; margin: 0px 0px 0px 20px; border: solid 1px #b5b0b0;">
                                <div style="border-bottom: solid 1px #b5b0b0;">
                                    <h5 style="font-family: 'Segoe UI'; padding-top: 5px;">Grievance Details:</h5>
                                </div>
                                ...
                                <div class="row" style="margin: 0px">
                                    <div class="col-md-4" style="border-bottom: solid 1px #b5b0b0;">
                                        <label style="font-family: 'Segoe UI'; padding-top: 5px;">Mobile Number</label>
                                    </div>
                                    <div class="col-md-8" style="text-align: right; border-bottom: solid 1px #b5b0b0;">
                                        <label runat="server" id="lblMobileNo" style="font-family: 'Segoe UI'; color: brown; font-size: 25px; padding-top: 5px;"></label>
                                    </div>
                                </div>
                                <div class="row" style="margin: 0px">
                                    <div class="col-md-4" style="border-bottom: solid 1px #b5b0b0;">
                                        <label style="font-family: 'Segoe UI'; padding-top: 5px;">Subject</label>
                                    </div>
                                    <div class="col-md-8" style="text-align: right; border-bottom: solid 1px #b5b0b0;">
                                        <label runat="server" id="lblSubject" style="font-family: 'Segoe UI'; color: brown; font-size: 25px; padding-top: 5px;"></label>
                                    </div>
                                </div>
                                <div class="row" style="margin: 0px">
                                    <div class="col-md-4" style="border-bottom: solid 1px #b5b0b0;">
                                        <label style="font-family: 'Segoe UI'; padding-top: 5px;">Department</label>
                                    </div>
                                    <div class="col-md-8" style="text-align: right; border-bottom: solid 1px #b5b0b0;">
                                        <label runat="server" id="lblDept" style="font-family: 'Segoe UI'; color: brown; font-size: 25px; padding-top: 5px;"></label>
                                    </div>
                                </div>
                                <div class="row" style="margin: 0px">
                                    <div class="col-md-4" style="border-bottom: solid 1px #b5b0b0;">
                                        <label style="font-family: 'Segoe UI'; padding-top: 5px;">Remark</label>
                                    </div>
                                    <div class="col-md-8" style="text-align: right; border-bottom: solid 1px #b5b0b0;">
                                        <label runat="server" id="lblRemark" style="font-family: 'Segoe UI'; color: brown; font-size: 25px; padding-top: 5px;"></label>
                                    </div>
                                </div>
                                <div class="row" style="margin: 0px">
                                    <div class="col-md-4" style="border-bottom: solid 1px #b5b0b0;">
        ...
        <%--<div class="QuickLink">
            <div class="fixed-bottom">
                <div class="row fixed-row-bottom" id="QuickLink" style="margin-top: 1%; background-color: #cdcdcd; margin-right: 0px; width: 96%; border-radius: 15px; margin-left: 26px;">
                   ...
                   <%-- <div class="col-md-12"></div>--
                    ...
                    <div class="col-md-8" style="margin-left: 0px; margin-top: 1%">
                        <a href="Ambulance.aspx" class="carouselPointers" onclick="HideQuicklink();"><span class="imgSpan" style="position: relative; background-color: #f8f9fa">
                            <img src="images/Ambulance.png" style="margin-bottom: 25px; text-align: center; height: 60px; margin-top: -8px;" /></span><br /><%=Resources.Resource.Ambulance %></a> &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="BloodBank.aspx" class="carouselPointers" onclick="HideQuicklink();"><span class="imgSpan" style="position: relative; background-color: #f8f9fa">
                            <img src="images/bloodbank.png" /></span><br /><%=Resources.Resource.Blood %> <%=Resources.Resource.Bank %></a> &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="FireBrigde.aspx" class="carouselPointers" onclick="HideQuicklink();"><span class="imgSpan" style="position: relative; background-color: #f8f9fa">
                            <img src="images/fire.png" style="height: 30px; margin-top: 5px;" /></span><br /><%=Resources.Resource.Fire %> <%=Resources.Resource.Brigade %></a> &nbsp;&nbsp;
                        <a href="Hospital.aspx" class="carouselPointers" onclick="HideQuicklink();"><span class="imgSpan" style="position: relative; background-color: #f8f9fa">
                            <img src="images/hospital.png" style="height: 31px;  margin-top: 5px;" /></span><br /><%=Resources.Resource.Hospitals %></a> &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="Police.aspx" class="carouselPointers" onclick="HideQuicklink();"><span class="imgSpan" style="position: relative; background-color: #f8f9fa">
                            <img src="images/police.png" style="height: 40px" /></span><br /><%=Resources.Resource.Police %></a> &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="Chemist.aspx" class="carouselPointers" onclick="HideQuicklink();"><span class="imgSpan" style="position: relative; background-color: #f8f9fa">
                            <img src="images/chemist.png" style="height: 35px; margin-top: 2px;" /></span><br /><%=Resources.Resource.Chemist %></a> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <style>
            h1 {
                xt-align: e font-family: Tahoma, Ar f color: #06D85F;
                margin: 80px 0;
                wid marg n: 0 auo;
                029;
                px;
                1 adius: 5px/ ba kround;
                t button m;
                padd color: #fff;
                2px solid eb0029;
                : 20px/ 0 text-de oratio ursor tr ease-o t;
            }
            ...
            .button:hover {
                ...
                ;
                ttom: 0;
                right gba(0, 0 t ansiti ity: hi de opa it
            }
