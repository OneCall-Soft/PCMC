<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Entertainment1.aspx.cs" Inherits="Entertainment1" %>
...
<body style="overflow: hidden">
    <form id="form1" runat="server">
        ...
        <div class="container-fluid" style="background-color: #ff8f00;">
            <%--Div to show the data--%>
            <div class="row" style="background-color: #ff8f00; height: 80px;">
                <div class="col-md-4 col-sm-4" style="text-align: left; margin-top: 2%">
                    <%-- <a runat="server" style="font-size: 18px; font: bold; color: #fff; opacity: 0.5;"><%=Resources.Resource.Home %>/</a>
                            <a style="font-size: 18px; font: bold; color: white"><%=Resources.Resource.entertainment %></a>--%>
                </div>
                <div class="col-md-4 col-sm-4" style="align-content: center; justify-content: center; display: flex;">
                    <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%=Resources.Resource.entertainment %></span>
                </div>
                <div class="col-md-4 col-sm-4" style="margin: 11px 12px 75px 20px; height: 77px; max-width: 30%; text-align: right;">
                    <a href="Default.aspx">
        ...
        <%--Div to show the data--%>
            ...
            <div class="row" style="text-align: center;">
                <div class="" style="position: absolute; width: 100%; /* left: 15%; */margin-top: 0%; background: #eee; /* border-radius: 10px; */text-align: center; height: 85%; /* box-shadow: 0px 6px 20px 0px #000000c7; */">
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: 7%;">
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-2 col-sm-2" style="margin: 20px 20px 20px 80px; height: 132px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="http://pubauditorium.pcmcindia.gov.in:8085/Auditorium/Wicket/">
                                    <span class="imgSpan" style="position: relative; position: center;">

                                        <i class="fa fa-university fa-5x" style="color: #ff8f00;"></i>
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.Auditorium %>
                                    </span>
                                </a>
                            </div>

                            <div class="col-md-2 col-sm-2" style="margin: 20px 20px; height: 132px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="https://www.d2h.com/recharge/recharge">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/D2H.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.D2HRecharge %>
                                    </span>
                                </a>
                            </div>

                            <div class="col-md-2 col-sm-2" style="margin: 20px 20px; height: 132px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="MovieTicket1.aspx">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <i class="fa fa-video-camera fa-5x" style="color: #ff8f00;"></i>
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.Movies %>
                                    </span>
                                </a>
                            </div>
                            <div class="col-md-2 col-sm-2"></div>
                    ...
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: -1%;">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px 20px 80px; height: 132px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="http://www.pcmcsports.in/new-admin/login.php">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <i class="fa fa-futbol-o fa-5x" style="color: #ff8f00;"></i>
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.Sports %>
                                    </span>
                                </a>
                            </div>

                            <%--  <div class="col-sm-2" style="margin:20px 20px; height:100px; background:#FFFFFF; border-radius:10px;">
                            <span class="imgSpan" style="position: relative; position: center; ">
                                <img src="images/transport3.png" style="height:70px;" />
                            </span>
                            <br />
                            <span style="font-family:'Segoe UI'; font-size:20px;">
                        ...
                        <div class="col-sm-2" style="margin:20px 20px; height:100px; background:#FFFFFF; border-radius:10px;">
                            <span class="imgSpan" style="position: relative; position: center; ">
                                <img src="images/rts.png" style="height:70px;" />
                            </span>
                            <br />
                            <span style="font-family:'Segoe UI'; font-size:20px;">
        ...
        <div class="fixed-bottom">
            <div class="row" id="QuickLink" style="background-color: #cdcdcd; width: 100%;">

                <%-- <div class="col-md-12"></div>--%>


                <div class="col-md-2 col-sm-2" style="padding-top: 37px; padding-left: 55px">
                    <h5><span style="color: darkgreen; font: bold; font-size: 20px;"><%=Resources.Resource.quicklinks %></span></h5>
                </div>
                <div class="col-md-9 col-sm-9 gap" style="margin-left: 0px; margin-top: 1%">
