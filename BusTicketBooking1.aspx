<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusTicketBooking1.aspx.cs" Inherits="Default2" %>
                ...
                <div class="col-sm-12" style="border: #000; width: 100%; margin-right: 0px; margin-top: -8%;">
                    <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                        <div class="row" style="background-color: #ff8f00;">
							...
							<a  href="PublicTransport1.aspx"  style="font-size: 18px; font: bold;color: #fff; opacity: 0.5;"><%=Resources.Resource.publictransport %>/</a>
                           <a  style="font-size: 18px; font: bold;color:white"><%=Resources.Resource.Bus %></a>--%>
                            </div>

                            <div class="col-sm-4" style="margin-top: 20px;">
                                <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%=Resources.Resource.Bus %></span>
                            </div>
                ...
                <div class="" style="position: absolute; width: 101%; /* left: 15%; */margin-top: -7%; background: #eee; /* border-radius: 10px; */text-align: center; height: 85%; /* box-shadow: 0px 6px 20px 0px #000000c7; */">
                    ...
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: 7%;">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px 20px 80px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                ...
                                <a href="https://www.redbus.in/?gclid=CjwKCAjw7anqBRALEiwAgvGgmwtX1U4VE5eocIaknCGSb6sx0SJBOBFcHA7jCioGhGCAFYbQu6BI3hoCcG8QAvD_BwE">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <%--   <i class="fa fa-building fa-5x" style="color:#ff8f00;" ></i>--%>
                                        <img src="images/redbus.png" style="height: 70px;" />

                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.RedBus %>
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                ...
                                <a href="https://www.abhibus.com/abhioffer?gclid=CjwKCAjw7anqBRALEiwAgvGgm7_KFbE7XxV3bX1_NK0_M6wCNWyMNb4T7TII21vHwGKgjnH5n9qpdRoCATEQAvD_BwE,">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/abhibus3.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.AbhiBus %>
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px; border: 1px solid #ff8f00; padding: 10px; height: 150px; background: #FFFFFF; border-radius: 10px;">
                                ...
                                <a href="https://www.makemytrip.com/bus-tickets/?gclid=CjwKCAjw7anqBRALEiwAgvGgmxSZmPoDPHGNNRCreGoej0cY6N_soAL1w7APagdHZLhxunAOKKUBYRoCyQ8QAvD_BwE&&ef_id=CjwKCAjw7anqBRALEiwAgvGgmxSZmPoDPHGNNRCreGoej0cY6N_soAL1w7APagdHZLhxunAOKKUBYRoCyQ8QAvD_BwE:G:s&cmp=SEM|D|BUS|G|DSA|DSA_Bus-Home|1-DSA-Bus|ETA|Regular|305533672474&s_kwcid=AL!1631!3!305533672474!b!!g!!,">

                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/mmt.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.MakeMyTrip %> 
                                    </span>
                                </a>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: -1%;">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px 20px 80px; border: 1px solid #ff8f00; padding: 10px; height: 150px; background: #FFFFFF; border-radius: 10px;">


                                <a href="https://www.cleartrip.com/offers/india/hotel-bus">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img src="images/cleartrip.png" style="height: 70px;" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.ClearTrip %>
                                    </span>
                                </a>
                            </div>
