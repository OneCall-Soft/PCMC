<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InfoServices1.aspx.cs" Inherits="Default2" %>
        ...
        <div style="background-color: #ff8f00; height: 213px;">
                    ...
                    <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                        <div class="row" style="background-color: #ff8f00;">
                            ...
                            <div class="col-sm-4" style="margin-top: 20px;">
                                <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%=Resources.Resource.InformationServices %></span>
                            </div>
            ...
            <div class="row" style="text-align: center;">
                <div class="" style="position: absolute; width: 101%; /* left: 15%; */ margin-top: -7%; background: #eee; /* border-radius: 10px; */ text-align: center; height: 85%; /* box-shadow: 0px 6px 20px 0px #000000c7; */">
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: 7%; /*padding-left: 13%; */">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="http://www.smartcitypimprichinchwad.in/">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <i class="fa fa-university fa-5x" style="color: #ff8f00;"></i>
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.smartcitynearme %>
                                    </span>
                                </a>
                            </div>
                            <div class="col-sm-2" style="margin: 20px 20px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="naagarvastivibhag.aspx">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <i class="fa fa-university fa-5x" style="color: #ff8f00;"></i>
                                    </span>
                                    <br />
                    ...
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: -1%;">
                            ...
                            <div class="col-sm-2" style="margin: 20px 20px 20px 80px; border: 1px solid #ff8f00; padding: 10px; height: 150px; background: #FFFFFF; border-radius: 10px;">
                                <a href="https://www.pcmcindia.gov.in/cfc_info.php">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <i class="fa fa-recycle fa-5x" style="color: #ff8f00;"></i>
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 18px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.CitizensFacilitationCenters %>
                                    </span>
                                </a>
                            </div>
                            <div class="col-sm-2" style="margin: 20px 20px; border: 1px solid #ff8f00; padding: 10px; height: 150px; background: #FFFFFF; border-radius: 10px;">
                                <a href="https://www.pcmcindia.gov.in/ward.php">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <img style="width: 150px; height: 90px" src="images/Ward.png" />
                                    </span>
                                    <br />
                                    <span style="font-family: 'Segoe UI'; font-size: 20px; text-decoration: none; color: #ff8f00;">
                                        <%=Resources.Resource.WardFacilities %>
                                    </span>
                                </a>
                            </div>
                        </div>
