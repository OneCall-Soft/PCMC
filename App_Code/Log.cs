        ...
        public static void Write(string inText, string strKioskIP)
        {
            try
            {
                ...
                string strPath = "";
                    ...
                    strPath = "C:\\PCMCWebsite\\" + DateTime.Now.ToString("MMM yy");

                // Create directory if not exist
                if (!Directory.Exists(strPath))
                    Directory.CreateDirectory(strPath);

                if (!File.Exists(strPath + "\\PCMCTxn_" + DateTime.Today.ToString("dd_MM_yyyy") + ".txt"))
                {
                   
                        File.WriteAllText(strPath + "\\PCMCTxn_" + DateTime.Today.ToString("dd_MM_yyyy") + ".txt",
                ...
                StreamWriter swFile = new StreamWriter(strPath + "\\PCMCTxn_" + DateTime.Today.ToString("dd_MM_yyyy") + ".txt", true);
