<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Police1.aspx.cs" Inherits="Police1" %>
        ...
        <div style="background-color: #0c529c; height: 578px;">
                    ...
                    <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                        <div class="row" style="background-color: #0c529c;">
                            ...
                            <div class="col-sm-4" style="text-align: left; margin-top: 2%">
								...
								<a style="font-size: 18px; font: bold; color: white"><%=Resources.Resource.Police %></a>--%>
                            </div>
                            <div class="col-sm-4" style="margin-top: 20px;">
                                <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%=Resources.Resource.Police %></span>
                            </div>
            ...
            <div class="row" style="text-align: center; padding-left: 3%;">
                <div class="" style="position: absolute; border: solid 1px #f00; width: 96%; margin-top: -6%; background: #eee; border-radius: 10px; text-align: center; height: 507px;">
                    <div class="row" style="padding-left: 25%; padding-top: 14px; overflow: overlay; height: 500px; margin-top: auto">
                        <div class="row" runat="server" style="background-color: #f8f7f7; padding: 16px; width: 70%; margin-top: 1%; border: 4px solid red; border-top: 4px solid red">
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="text-align: left;">
                                    ...
                                    <div class="panel-heading" role="tab" id="headingOne" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="color: White">
                                                ...
                                                <%=Resources.Resource.Police1 %><span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27123121</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P1 %>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingTwo" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police2 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27650036</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P2 %>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingThree" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police3 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27124728</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P3 %>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingFour" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police4 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27356767</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P4 %>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingFive" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police5 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27487777</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P5 %>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingSix" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police6 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P6 %>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingSeven" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police7 %>  <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>22932119</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P7 %>
                                        </div>
                                    </div>
                                </div>

                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingEight" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseEight" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police8 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingNine" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseNine" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police9 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P6 %>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingTen" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTen" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police10 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseTen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P6 %>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingEleven" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police11 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseEleven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P6 %>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingTwelve" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police12 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseTwelve" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P6 %>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingThirteen" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThirteen" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police13 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseThirteen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P6 %>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingFourteen" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFourteen" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police14 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseFourteen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            <%=Resources.Resource.P6 %>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingFifteen" style="background-color: #08223D">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFifteen" aria-expanded="false" aria-controls="collapseTwo" style="color: White">
                                                <i class="short-full glyphicon glyphicon-plus" style="background-color: #c52d2f; height: 22px; text-align: center; width: 36px;"></i>
                                                <%=Resources.Resource.Police15 %> <span style="float: right; padding-right: 40px; font-weight: 400; color: White"><i style="margin-right: 10px;" class="fa fa-phone" aria-hidden="true"></i>27149538</span>
                                            </a>
                                        </h4>
                                    </div>
