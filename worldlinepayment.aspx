<%@ Page Language="C#" AutoEventWireup="true" CodeFile="worldlinepayment.aspx.cs" Inherits="worldlinepayment" %>
...
<body style="overflow: hidden">
    <form id="form1" runat="server">
        ...
        <div style="background-color: rgb(0,181,250); height: 213px;">
                ...
                <div class="" style="position: absolute; width: 101%; /* left: 15%; */ margin-top: -7%; background: #eee; /* border-radius: 10px; */ text-align: center; height: 85%; /* box-shadow: 0px 6px 20px 0px #000000c7; */">
                    <div class="col-sm-12">
                        <div class="row" style="text-align: center; margin-top: 7%;">
                            ...
                            <div class="col-sm-3 slumbillingstyle" runat="server" id="slumbilling" style="margin: 20px 20px 20px 80px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="paymentbycard.aspx">
                                    <span class="imgSpan" style="position: relative; position: center;">
                                        <i class="fa fa-money fa-5x" style="color: #ff8f00;"></i>
                                    </span>
                                    <br />
                            ...
                            <div class="col-sm-3" style="margin: 20px 20px; height: 150px; background: #FFFFFF; border: 1px solid #ff8f00; padding: 10px; border-radius: 10px;">
                                <a href="worldlinecheckpaymentstatus.aspx" >
                                    <span class="imgSpan" style="position: relative; position: center;">
        ...
        <div id="myModal" runat="server" class="modal fade modal-lg" style="position: absolute; left: 0; right: 0; margin: auto; top: 0px; overflow: auto; height: 650px" role="dialog">
