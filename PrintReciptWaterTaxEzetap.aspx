<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintReciptWaterTaxEzetap.aspx.cs" Inherits="PrintReciptWaterTaxEzetap" %>
...
<body style="overflow: hidden;">
    ...
    <div style="height: 100%;">
        ...
        <label style="display: none;" runat="server" id="hdnAddress"></label>
                        ...
                        <div class="col-md-11" style="text-align: left; margin: 0px 0px 0px 20px; border: solid 1px #b5b0b0;">
                            ...
                            <div class="row" style="margin: 15px">
                                ...
                                <div class="col-md-6" style="text-align: center;">
                                    ...
                                    <button id="RecBtn" class="btn btn-primary active" onclick="Print1()">Print Receipt</button>
    ...
    <style>
        {
            text-align: center font-family: Tahoma, Aria s-serif;
            r: #06D85F;
            m rgin: 80px .box
...

        {
            ...
            border-ra 20px/50px;
            ext-decorati one;
            cu sor: po r transit o l 0.3s eas -out;
            .b tton:
        ...
        .ov {
            ...
            bottom 0;
            ft: 0;
            right backgro nd: rgba0, 0, 0,;
            ansition: opa i ms;
            vis bility: n opacity: 0
        }
        ...
        {
            mrgn: 70px paddin : 20px;
            ba und: #fff;
            bord dius: 5p;
            w 5%;
            positio: ive;
            tr nsition: s ease-i -o .po u

        {
            argi-top: colo : #33 font-fam ly: T, Arial, sans- erif
        }
        ...
        .close {
            ...
            op 20px;
            t ra s all 200ms;
            t-size 30px font-weight bold;
            tet-decoratio n color #333;
            .po up .close
