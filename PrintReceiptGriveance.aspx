<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="PrintReceiptGriveance.aspx.cs" Inherits="PropertyTax" %>
                ...
                <div style="border-radius: 10px; height: auto; background: rgba(255, 255, 255, 0.51);">
                    <div class="row" style="background-color: #0c529c;">
                        ...
                        <div class="col-sm-4" style="margin-top: 20px;">
                            <span style="margin-top: 15px; text-align: center; color: whitesmoke; font-size: 30px; font-family: 'Source Sans Pro',sans-serif"><%= Resources.Resource.ComplaintReceipt %></span>                        </div>
                    ...
                    <div class="col-md-6" style="padding-right: 0px;">
                        <div class="col-md-11" style="text-align: left; margin: 0px 0px 0px 20px; border: solid 1px #b5b0b0;">
                            <div style="border-bottom: solid 1px #b5b0b0;">
                                <h5 style="font-family: 'Segoe UI'; padding-top: 5px;"><%= Resources.Resource.ComplaintRegisteredMessage %>! </h5>
                            </div>

                            <div class="row" style="margin: 0px">
                                <div class="col-md-4" style="border-bottom: solid 1px #b5b0b0;">
                                    <label style="font-family: 'Segoe UI'; padding-top: 5px;"><%= Resources.Resource.YourtokenID %> </label>
                                </div>
                                <div class="col-md-8" style="text-align: center; border-bottom: solid 1px #b5b0b0;">
                                    <label runat="server" id="lblPaymentMode" style="font-family: 'Segoe UI'; color: brown; font-size: 25px; padding-top: 5px;"></label>
                                </div>
                            </div>
                            <div class="row" style="margin: 0px">
                                <div class="col-md-4" style="border-bottom: solid 1px #b5b0b0;">
                                    <label style="font-family: 'Segoe UI'; padding-top: 5px;"><%= Resources.Resource.Date %></label>
                                </div>
                                <div class="col-md-8" style="text-align: center; border-bottom: solid 1px #b5b0b0;">
                                    <label runat="server" id="lblTxnDate" style="font-family: 'Segoe UI'; color: brown; font-size: 25px; padding-top: 5px;" />
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin: 15px">
                                ...
                                <div class="col-md-6" style="text-align: center;">
                                    ...
                                    <%--<input id="btnPrintReceipt" style="" type="button" onclick="Print()"  />--%>
                                    <button id="RecBtn" class="btn btn-primary active" onclick="Print()"><%= Resources.Resource.PrintReceipt %></button>
